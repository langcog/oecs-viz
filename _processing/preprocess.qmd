...
udmodel <- udpipe_load_model(
  file = here("resources/english-ewt-ud-2.5-191206.udpipe"))
...
glove <- data.table::fread(file = here("resources/glove.6B.50d.txt"),
                           sep = " ", quote = "")
...
save(pubs_similarity_graph_combined, slugs, file = "data/pub_graph.RData")
```
